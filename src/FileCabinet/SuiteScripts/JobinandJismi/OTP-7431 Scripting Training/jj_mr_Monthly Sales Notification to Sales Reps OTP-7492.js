    ...
    (email, file, record, search, log) => {
        ...
        const reduce = (reduceContext) => {
            try{
                ...
                let noSalesRepCsvData = 'Customer Name, Customer Email, Sales Order Document Number, Sales Amount\n';
                ...
                details.forEach(function(data){
                    ...
                    let cmail = customerRecord.getValue('email');
                    if(repId === 'noSalesRep'){
                        noSalesRepCsvData += data.cName + ',' + cmail + ',' + data.docNumber + ',' + data.total + '\n';
                    }
                    else{
                ...
                let csvFile1 = file.create({
                    name: 'Monthly Sales Orders - No Sales Rep.csv',
                    fileType: file.Type.CSV,
                    contents: noSalesRepCsvData,
                    folder: -15
                });
                let fileId1 = csvFile1.save();
                let csvFile2 = file.create({
                    name: 'Monthly Sales Orders - '+ repId +'.csv',
                    fileType: file.Type.CSV,
                    contents: csvData,
                    folder: -15
                });
                let fileId2 = csvFile2.save();
                ...
                if(repId === 'noSalesRep'){
                    email.send({
                        ...
                        body: 'Dear Sales Rep,\n Sales Orders with no Sales Reps associated to them. Please add Sales Reps to these records.\nThank You.',
                    ...
                    email.send({
                        ...
                        recipients: repId,
                        subject:'Monthly Sales Orders (' + currentMonthName + ')',
                        body: 'Dear Sales Rep,\n List of Sales Orders of ' + currentMonthName + ' is included in the file attached to this email. Kindly Go through it and verify if it is correct.\nThank You.',
                        attachments: [file.load({
                            id: fileId2
                        })]
                    });
                ...
                log.error('Error found in Reduce ', e.stack);
            }
        }
